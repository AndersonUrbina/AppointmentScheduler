...
namespace MedScheduler
{
    public class Appointment
    {
		...
		//Creapublic Appointment(string id, string patientName, string providerName, DateTime start, DateTime end, string room)
        ...
        public Appointment(string id, string patientName, string providerName, DateTime start, DateTime end, string room)
        {
            ...
            if (string.IsNullOrEmpty(room))
                throw new ArgumentException("Room cannot be blank.");
            if (end <= start)
